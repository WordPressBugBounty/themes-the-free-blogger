 ...
 * Slug: the-free-blogger/sidebar
 * Categories: the-free-blogger
 * Description: Sidebar content
 * Keywords: Sidebar content
 */
?>
<!-- wp:group {"style":{"spacing":{"padding":{"top":"20px","bottom":"var:preset|spacing|30","left":"var:preset|spacing|30","right":"var:preset|spacing|30"}},"border":{"left":{"color":"var:preset|color|tertiary","width":"1px"}}},"className":"the-free-blogger-sidebar","layout":{"type":"constrained","justifyContent":"left"}} -->
<div class="wp-block-group the-free-blogger-sidebar" style="border-left-color:var(--wp--preset--color--tertiary);border-left-width:1px;padding-top:20px;padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)"><!-- wp:group {"layout":{"type":"default"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"24px"}}} -->
<h3 class="wp-block-heading" style="font-size:24px"><?php echo esc_html_x( 'Looking for something?', 'the-free-blogger' ); ?></h3>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading" style="margin-top:50px;font-size:24px"><?php echo esc_html_x( 'Latest Articles', 'the-free-blogger' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:group {"layout":{"type":"default"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"24px"},"spacing":{"margin":{"top":"50px"}}}} -->
<h3 class="wp-block-heading" style="margin-top:50px;font-size:24px"><?php echo esc_html_x( 'Follow Us', 'the-free-blogger' ); ?></h3>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading" style="margin-top:50px;margin-bottom:20px;font-size:24px"><?php echo esc_html_x( 'Advertisement', 'the-free-blogger' ); ?></h3>
<!-- /wp:heading -->
