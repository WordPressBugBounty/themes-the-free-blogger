...
/**
 * Title: Hidden 404
 * Slug: the-free-blogger/hidden-404
 * Inserter: no
 */
?>
...
<h1 class="wp-block-heading alignwide has-text-align-center" style="font-size:9rem"><?php echo esc_html_x( '404', 'the-free-blogger' ); ?></h1>
<!-- /wp:heading -->
...
<p class="has-text-align-center"><?php echo esc_html_x( 'This page could not be found.', 'the-free-blogger' ); ?></p>
<!-- /wp:paragraph -->
